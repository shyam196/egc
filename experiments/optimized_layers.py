"""This code was mostly upstreamed to PyTorch Geometric."""
...
from torch_sparse.diag import fill_diag
...
class EGConv(MessagePassing):
    ...
    def forward(self, x: Tensor, edge_index: Adj) -> Tensor:
        ...
        weightings = weightings.view(
            num_nodes, self.num_heads, self.num_bases * len(self.aggregators)
        )
    ...
    def aggregate(
        ...
        for aggregator in self.aggregators:
            if aggregator == "sum":
                ...
                out = scatter(
                    inputs * symnorm_weight, index, 0, None, dim_size, reduce="sum"
                )
